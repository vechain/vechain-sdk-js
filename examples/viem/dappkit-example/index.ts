...
const thorClient = (publicClient as unknown as { thorClient: any }).thorClient;
...
async function createTransactionRequest(): Promise<TransactionRequest> {
    ...
    const clauses = ClauseBuilder.transferVET(
...
const toTransactionRequestInput = (
    ...
    return {
        ...
        gas: Number(json.gas),
        gasPriceCoef:
            json.gasPriceCoef !== undefined
                ? Number(json.gasPriceCoef)
                : undefined,
