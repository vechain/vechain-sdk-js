...
const clientWithCustomOptions = createPublicClient({
    network: new URL('https://testnet.vechain.org'),
    transport: new FetchHttpClient(new URL('https://testnet.vechain.org'), {
        timeout: 10000,
        headers: {
...
async function demonstrateUsage(): Promise<void> {
    try {
        ...
        const balance1 = await defaultClient.getBalance(
            Address.of('0xf077b491b355e64048ce21e3a6fc4751eeea77fa')
        );
        const balance2 = await testClient.getBalance(
            Address.of('0xf077b491b355e64048ce21e3a6fc4751eeea77fa')
        );
        const balance3 = await clientWithCustomOptions.getBalance(
            Address.of('0xf077b491b355e64048ce21e3a6fc4751eeea77fa')
        );
        const balance4 = await clientWithCallbacks.getBalance(
            Address.of('0xf077b491b355e64048ce21e3a6fc4751eeea77fa')
        );
