      ...
      <div>
        ...
        <div className="card">
          <p>
            ...
            <Link className="text-blue-500 hover:underline" to="/hash" // Change from href to to for React Router
    >
              Hash
            </Link>
          </p>
          <p>
            ...
            <Link className="text-blue-500 hover:underline" to='/transfer-logs'>
              Transfer logs
            </Link>
          </p>
          <p>
            <b>@vechain/sdk-network</b> integration example:{' '}
            <Link className="text-blue-500 hover:underline" to='/get-last-block'>
              Get Last Block
            </Link>
          </p>
        </div>
