...
const Hash = () => {
    ...
    const [contentToHash, setContentToHash] = useState('Hello World!');
    ...
    return (<main className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        }} value={contentToHash} className="block mx-auto w-full sm:max-w-md border-2 border-dark focus:border-purple-500 bg-transparent py-2 px-4 text-lg text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 outline-none rounded-md" placeholder="hello"/>
            </div>
