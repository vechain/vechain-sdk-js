 ...
 */
(0, globals_1.describe)('Using eth_getTransactionCount with default value as 0x0', () => {
    /**
    ...
    (0, globals_1.beforeEach)(function () {
        // Set hardhat context
        (0, test_utils_1.setHardhatContext)('eth_getTransactionCount-default-value-project');
    ...
    (0, globals_1.describe)('Custom network configuration hardhat', () => {
         ...
         */
        (0, globals_1.test)('Should be able to get a default value of 0x0 from a project', async () => {
            ...
            (0, globals_1.expect)(networkConfig.rpcConfiguration
                ?.ethGetTransactionCountMustReturn0).toBe(true);
            // Get the provider
            ...
            (0, globals_1.expect)(request).toBe('0x0');
        });
    });
});
