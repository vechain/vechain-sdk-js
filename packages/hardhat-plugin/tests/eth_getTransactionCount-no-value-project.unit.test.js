 ...
 */
(0, globals_1.describe)('Using eth_getTransactionCount with no options specified. So it will return a random number', () => {
    /**
    ...
    (0, globals_1.beforeEach)(function () {
        // Set hardhat context
        (0, test_utils_1.setHardhatContext)('eth_getTransactionCount-no-value-project');
    ...
    (0, globals_1.describe)('Custom network configuration hardhat', () => {
         ...
         */
        (0, globals_1.test)('Should be able to get a random value from a project when no options are specified', async () => {
            ...
            (0, globals_1.expect)(networkConfig.rpcConfiguration
                ?.ethGetTransactionCountMustReturn0).toBe(undefined);
            // Get the provider
