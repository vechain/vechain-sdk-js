...
import { Address, Hex, type TransactionBody } from '../../src';
    ...
    undelegated: [
        {
            ...
            encodedUnsignedExpected: Uint8Array.from(
                Hex.of(
            ...
            encodedSignedExpected: Uint8Array.from(
                Hex.of(
        ...
        // Delegate transaction with unused field
        {
            body: {
                ...
                reserved: {
                    features: 1,
                    unused: [
                        Uint8Array.from(Hex.of('0x000').bytes),
                        Uint8Array.from(Hex.of('0x000').bytes)
                    ]
                }
            },
 ...
 */
const invalidDecodedNotTrimmedReserved = Uint8Array.from(
    Hex.of(
