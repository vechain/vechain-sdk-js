...
import { Txt, _blake2b256, _blake2b256OfHex, type ReturnType } from '../../src';
...
describe('blake2b256', () => {
    describe('blake2b256', () => {
        ...
        test('blake2b256 - valid content - string', () => {
            ...
            actual = _blake2b256(content);
            expect(actual).toEqual(expected);
            actual = _blake2b256(content, 'buffer');
            expect(actual).toEqual(expected);
            actual = _blake2b256(content, 'hex');
        ...
        test('blake2b256 - valid content - Uint8Array', () => {
            const expected = Hex.of(BLAKE2B256_CONTENT_HASH).bytes;
            let actual: string | Uint8Array;
            actual = _blake2b256(BLAKE2B256_CONTENT);
            expect(actual).toEqual(expected);
            actual = _blake2b256(BLAKE2B256_CONTENT, 'buffer');
            expect(actual).toEqual(expected);
            actual = _blake2b256(BLAKE2B256_CONTENT, 'hex');
            expect(actual).toEqual(BLAKE2B256_CONTENT_HASH);
        });
        ...
        test('blake2b256 - valid no content - Uint8Array', () => {
            ...
            let actual: string | Uint8Array;
            actual = _blake2b256(BLAKE2B256_NO_CONTENT);
            expect(actual).toEqual(expected);
            actual = _blake2b256(BLAKE2B256_NO_CONTENT, 'buffer');
            expect(actual).toEqual(expected);
            actual = _blake2b256(BLAKE2B256_NO_CONTENT, 'hex');
        ...
        test('blake2b256 - valid zero content - string', () => {
            ...
            actual = _blake2b256('');
            expect(actual).toEqual(expected);
            actual = _blake2b256('', 'buffer');
            expect(actual).toEqual(expected);
            actual = _blake2b256('', 'hex');
            expect(actual).toEqual(BLAKE2B256_NO_CONTENT_HASH);
        });
    });
    ...
    describe('blake2b256OfHex', () => {
        ...
        test('blake2b256OfHex - invalid hex', () => {
            expect(() => _blake2b256OfHex('coffee')).toThrowError(
                InvalidDataType
            );
        });
        ...
        test('blake2b256OfHex - valid - content', () => {
            const expected = Hex.of(BLAKE2B256_CONTENT_HASH).bytes;
            let actual = _blake2b256OfHex(content);
            expect(actual).toEqual(expected);
            actual = _blake2b256OfHex(content, 'hex');
            expect(actual).toEqual(BLAKE2B256_CONTENT_HASH);
        });

        test('blake2b256OfHex - valid - no content', () => {
            const expected = Hex.of(BLAKE2B256_NO_CONTENT_HASH).bytes;
            let actual = _blake2b256OfHex(zeroContent);
            expect(actual).toEqual(expected);
            actual = _blake2b256OfHex(zeroContent, 'hex');
            expect(actual).toEqual(BLAKE2B256_NO_CONTENT_HASH);
        });
    });
});
