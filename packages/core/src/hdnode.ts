import { Base58 } from 'ethers/utils/basex'
import * as HD from 'ethers/utils/hdnode'
...
function fromMnemonic(words: string[], path = VET_DERIVATION_PATH) {
 ...
 */
function fromPublicKey(pub: Buffer, chainCode: Buffer) {
 ...
 * @param chainCode chain code
 */
function fromPrivateKey(priv: Buffer, chainCode: Buffer) {
