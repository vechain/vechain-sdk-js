 ...
 * * only the properties defined in the {@link CertificateData} interface are evaluated;
 ...
 *
 * @param {CertificateData} cert - The certificate object to encode.
 ...
 * @see {verify}
 */
function encode(cert: CertificateData): Uint8Array {
    return Txt.of(
 ...
 * - {@link Secp256k1.sign}.
 *
 * @param {CertificateData} cert - The certificate to be signed.
 ...
 *
 * @returns {CertificateData} - A new instance of the certificate with the signature added.
 *
 * @throws {InvalidSecp256k1PrivateKey} - If the private key is invalid.
 *
 */
function sign(cert: CertificateData, privateKey: Uint8Array): CertificateData {
    return {
        ...cert,
        signature: Hex.of(
 ...
 * matches with the property {@link CertificateData.signer}.
 *
 ...
 */
export const _certificate = { encode, sign, verify };
