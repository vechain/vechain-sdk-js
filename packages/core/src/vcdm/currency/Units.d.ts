...
declare namespace Units {
     ...
     */
    function convertUnits(value: FixedPointNumber, fromUnits: Units, toUnits: Units): FixedPointNumber;
    /**
     ...
     */
    function formatFromUnits(value: FixedPointNumber, fromUnits: Units, toUnits: Units, displayDecimals?: number): string;
}
export { Units };
