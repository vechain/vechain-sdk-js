 ...
 * @extends HexUInt
 */
class Quantity extends HexUInt_1.HexUInt {
    /**
    ...
    static of(exp) {
        try {
            ...
            return new Quantity(huint.sign, cue === huint.digits.length ? '0' : huint.digits.slice(cue));
        }
        catch (e) {
            throw new sdk_errors_1.InvalidDataType('Quantity.of', 'not a Quantity expression', { exp: `${exp}` }, // Needed to serialize bigint values.
            e);
        }
    }
}
