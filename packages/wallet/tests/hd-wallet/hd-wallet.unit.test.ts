...
import { BaseWallet, HDWallet } from '../../src';
import { accountsFixture } from '../base-wallet/fixture';
...
import { hdNodeFixture } from './fixture';
...
describe('HDWallet wallet tests', () => {
    ...
    describe('getAccount', () => {
        ...
        test('Should be able to get an account by address', async () => {
            ...
            console.log(await hdWallet.getAddresses());
            // // Get the addresses from the wallet
            // const randomAccount =
            //     accountsFixture[
