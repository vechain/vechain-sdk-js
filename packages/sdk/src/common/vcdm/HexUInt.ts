 ...
 * Full Qualified Path
 */
const FQP = 'packages/sdk/src/common/vcdm/HexUInt.ts!';
...
class HexUInt extends HexInt {
     ...
     *   it throws {@link IllegalArgumentError} if not positive;
     * * number is converted to a bigint then represented in hexadecimal base notation,
     *   it throws {@link IllegalArgumentError} if not a positive integer value;
    ...
    public static of(
        ...
        try {
            ...
            throw new IllegalArgumentError(
                `${FQP}HexUInt.of(exp: bigint | number | string | Uint8Array | HexInt): HexUInt`,
                'not positive',
