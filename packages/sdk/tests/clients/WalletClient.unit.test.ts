...
describe('WalletClient UNIT tests', () => {
    describe('prepareTransactionRequest', () => {
        test('ok <- sponsored - thor and viem equivalence', () => {
            const latestBlock = {
        ...
        test('ok <- not sponsored - thor and viem equivalence', () => {
            const latestBlock = {
                id: '0x00000058f9f240032e073f4a078c5f0f3e04ae7272e4550de41f10723d6f8b2e'
            };
            const transferClause = ClauseBuilder.transferVET(
    ...
    describe('signTransaction', () => {
        test('ok <- sponsored - thor and viem equivalence', async () => {
            const latestBlock = {
                id: '0x00000058f9f240032e073f4a078c5f0f3e04ae7272e4550de41f10723d6f8b2e'
            };
            const transferClause = ClauseBuilder.transferVET(
            ...
            const signedTx = Transaction.of(txBody).signAsSender(
                HexUInt.of(TRANSACTION_SENDER.privateKey).bytes
            );
            const signedThor = HexUInt.of(signedTx.encode(true));
        ...
        test('ok <- not sponsored - thor and viem equivalence', async () => {
            const latestBlock = {
                id: '0x00000058f9f240032e073f4a078c5f0f3e04ae7272e4550de41f10723d6f8b2e'
            };
            const transferClause = ClauseBuilder.transferVET(
