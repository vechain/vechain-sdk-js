...
describe('RLPCodec Dynamic Fee Support', () => {
    ...
    describe('Dynamic Fee Transaction Encode/Decode', () => {
        ...
        test('ok <- signed dynamic fee transaction', () => {
            ...
            if (actual instanceof SignedTransactionRequest) {
                ...
                expect(actual.origin.toString()).toEqual(expected.origin.toString());
            }
        ...
        test('ok <- sponsored dynamic fee transaction', () => {
            ...
            expect(actual.blockRef.toString()).toEqual(expected.blockRef.toString());
            ...
            expect(actual.maxPriorityFeePerGas).toEqual(expected.maxPriorityFeePerGas);
        });
    ...
    describe('Legacy vs Dynamic Fee Detection', () => {
        ...
        test('ok <- mixed transaction types in same test', () => {
            ...
            // Decode both
            const legacyDecoded = RLPCodecTransactionRequest.decode(legacyEncoded);
            const dynamicDecoded = RLPCodecTransactionRequest.decode(dynamicEncoded);
            ...
            expect(dynamicDecoded.maxPriorityFeePerGas).toBe(mockMaxPriorityFeePerGas);
