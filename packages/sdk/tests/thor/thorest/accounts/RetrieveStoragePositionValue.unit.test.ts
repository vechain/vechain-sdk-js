        ...
        test('askTo() handles error response', async () => {
            ...
            try {
                ...
                expect(thorError.fqn).toBe(
                    'packages/sdk/src/thor/accounts/methods/RetrieveStoragePositionValue.ts!askTo(httpClient: HttpClient): Promise<ThorResponse<RetrieveStoragePositionValue, GetStorageResponse>>'
                );
