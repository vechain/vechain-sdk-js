...
describe('Contract Error Classes', () => {
    describe('ContractCallError', () => {
        test('Should create ContractCallError with basic parameters', () => {
            ...
            expect(error.tag).toBe('vechain-sdk-js:2.0.0-beta.1');
        });
        ...
        test('Should have proper toString representation', () => {
            ...
            expect(stringRep).toContain('@vechain-sdk-js:2.0.0-beta.1');
    ...
    describe('InvalidTransactionField', () => {
        ...
        test('Should create InvalidTransactionField with cause', () => {
            ...
            const error = new InvalidTransactionField(context, message, undefined, cause);
    ...
    describe('Error Inheritance', () => {
        test('Both error classes should extend VeChainSDKError', () => {
            ...
            const transactionError = new InvalidTransactionField('test', 'message');
        ...
        test('Should maintain proper error chain', () => {
            ...
            const contractError = new ContractCallError('test', 'message', undefined, rootCause);
