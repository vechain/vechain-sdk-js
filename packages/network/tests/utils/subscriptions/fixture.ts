...
import { _Hex0x, secp256k1 } from '../../../../core/src';

/**
 * random address for `from` parameter
 */
const fromRandomAddress = _Hex0x.of(secp256k1.randomBytes(20));

/**
 * random address for `to` parameter
 */
const toRandomAddress = _Hex0x.of(secp256k1.randomBytes(20));
