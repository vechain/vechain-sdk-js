...
(0, globals_1.describe)('Vechain provider tests - solo', () => {
    ...
    (0, globals_1.beforeEach)(() => {
        hardhatVeChainProvider = new src_1.HardhatVeChainProvider(new src_1.ProviderInternalBaseWallet([]), src_1.TESTNET_URL, (message, parent) => new Error(message, parent), false);
        jsonRPCEthersProvider = new src_1.JSONRPCEthersProvider(sdk_core_1.TESTNET_NETWORK.chainTag, src_1.TESTNET_URL, hardhatVeChainProvider);
    });
    /**
