...
(0, globals_1.describe)('VeChain provider tests - solo', () => {
    ...
    (0, globals_1.beforeEach)(() => {
        hardhatVeChainProvider = new src_1.HardhatVeChainProvider(new src_1.ProviderInternalBaseWallet([]), src_1.THOR_SOLO_URL, (message, parent) => new Error(message, parent), false);
        jsonRPCEthersProvider = new src_1.JSONRPCEthersProvider(sdk_core_1.SOLO_NETWORK.chainTag, src_1.THOR_SOLO_URL, hardhatVeChainProvider);
    });
    /**
