...
(0, globals_1.describe)('RPC Mapper - net_listening method tests', () => {
    ...
    (0, globals_1.describe)('Negative cases', () => {
        ...
        (0, globals_1.test)('Should throw `JSONRPCInternalError` when request fails', async () => {
            ...
            globals_1.jest.spyOn(thorClient.nodes, 'isHealthy').mockRejectedValue(new Error());
            await (0, globals_1.expect)(async () => await (0, src_1.RPCMethodsMap)(thorClient)[src_1.RPC_METHODS.net_listening]([])).rejects.toThrowError(sdk_errors_1.JSONRPCInternalError);
        });
    });
});
