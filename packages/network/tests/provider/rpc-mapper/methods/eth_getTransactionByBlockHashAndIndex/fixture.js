...
exports.invalidEthGetTransactionByBlockHashAndIndexTestCases = exports.ethGetTransactionByBlockHashAndIndexTestCases = void 0;
...
const ethGetTransactionByBlockHashAndIndexTestCases = [
    ...
    {
        description: "eth_getTransactionByBlockHashAndIndex with a hash that doesn't exist",
        params: [
            '0x010b7a6d6f04407ac2f72e505ff83d49db8d01607f8af41f508b2ca7eca0d450',
            '0x0'
        ],
...
exports.ethGetTransactionByBlockHashAndIndexTestCases = ethGetTransactionByBlockHashAndIndexTestCases;
/**
 * Negative test cases for eth_getTransactionByBlockHashAndIndex
 */
const invalidEthGetTransactionByBlockHashAndIndexTestCases = [
    {
        description: 'eth_getTransactionByBlockHashAndIndex with an invalid hash',
        params: ['0x123', '0x0'],
        expectedError: sdk_errors_1.JSONRPCInternalError
    },
    {
        description: 'eth_getTransactionByBlockHashAndIndex with an invalid index',
        params: [
    ...
    {
        description: 'eth_getTransactionByBlockHashAndIndex with too many params',
        params: ['0x123', '0x123', '0x123'],
        expectedError: sdk_errors_1.JSONRPCInvalidParams
    },
    {
        description: 'eth_getTransactionByBlockHashAndIndex with too few params',
        params: ['0x123'],
        expectedError: sdk_errors_1.JSONRPCInvalidParams
    },
    {
        description: 'eth_getTransactionByBlockHashAndIndex with invalid param type',
        params: ['0x123', 123],
        expectedError: sdk_errors_1.JSONRPCInvalidParams
    }
];
exports.invalidEthGetTransactionByBlockHashAndIndexTestCases = invalidEthGetTransactionByBlockHashAndIndexTestCases;
