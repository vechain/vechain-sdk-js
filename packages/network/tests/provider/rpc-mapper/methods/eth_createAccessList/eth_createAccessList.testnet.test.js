 ...
 */
(0, globals_1.describe)('RPC Mapper - eth_createAccessList method tests', () => {
    /**
     ...
     */
    (0, globals_1.describe)('eth_createAccessList - Not Implemented', () => {
        /**
        ...
        (0, globals_1.test)('Should throw JSONRPCMethodNotImplemented error', async () => {
            await (0, globals_1.expect)(provider.request({
                method: src_1.RPC_METHODS.eth_createAccessList,
                params: []
