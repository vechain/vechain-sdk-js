 ...
 */
(0, globals_1.describe)('RPC Mapper - engine_exchangeTransitionConfigurationV1 method tests', () => {
    /**
     ...
     */
    (0, globals_1.describe)('engine_exchangeTransitionConfigurationV1 - Not Implemented', () => {
        /**
        ...
        (0, globals_1.test)('Should throw JSONRPCMethodNotImplemented error', async () => {
            await (0, globals_1.expect)(provider.request({
                method: src_1.RPC_METHODS.engine_exchangeTransitionConfigurationV1,
                params: []
