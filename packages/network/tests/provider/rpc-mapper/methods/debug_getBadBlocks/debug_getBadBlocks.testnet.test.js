 ...
 */
(0, globals_1.describe)('RPC Mapper - debug_getBadBlocks method tests', () => {
    /**
     ...
     */
    (0, globals_1.describe)('debug_getBadBlocks - Not Implemented', () => {
        /**
        ...
        (0, globals_1.test)('Should throw JSONRPCMethodNotImplemented error', async () => {
            await (0, globals_1.expect)(provider.request({
                method: src_1.RPC_METHODS.debug_getBadBlocks,
                params: []
