 ...
 */
(0, globals_1.describe)('engine_getPayloadBodiesByRangeV1', () => {
    (0, globals_1.test)('should be defined in RPC_METHODS', () => {
        (0, globals_1.expect)(rpc_methods_1.RPC_METHODS.engine_getPayloadBodiesByRangeV1).toBeDefined();
        (0, globals_1.expect)(rpc_methods_1.RPC_METHODS.engine_getPayloadBodiesByRangeV1).toBe('engine_getPayloadBodiesByRangeV1');
    });
    ...
    (0, globals_1.test)('should be marked as a method to be implemented', () => {
        ...
        (0, globals_1.expect)(methodsToImplement).toContain('engine_getPayloadBodiesByRangeV1');
    });
});
