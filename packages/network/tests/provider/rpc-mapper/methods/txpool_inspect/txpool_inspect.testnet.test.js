 ...
 */
(0, globals_1.describe)('RPC Mapper - txpool_inspect method tests', () => {
    /**
     ...
     */
    (0, globals_1.describe)('txpool_inspect - Positive cases', () => {
        /**
         * Should return the transaction pool content
         */
        (0, globals_1.test)('Should return the transaction pool status', async () => {
            const txPoolInspect = await (0, src_1.RPCMethodsMap)(thorClient)[src_1.RPC_METHODS.txpool_inspect]([]);
