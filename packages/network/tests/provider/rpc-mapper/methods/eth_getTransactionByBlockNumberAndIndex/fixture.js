...
exports.invalidEthGetTransactionByBlockNumberAndIndexTestCases = exports.ethGetTransactionByBlockNumberAndIndexTestCases = void 0;
...
const ethGetTransactionByBlockNumberAndIndexTestCases = [
    {
        ...
        params: [sdk_core_1.HexInt.of(17529453).toString(), '0x1'],
        expected: {
    ...
    },
    {
        ...
        params: [sdk_core_1.HexInt.of(17529453).toString(), '0x0'],
        expected: {
            accessList: [],
            blockHash: '0x010b7a6d6f04407ac2f72e505ff83d49db8d01607f8af41f508b2ca7eca0d450',
            blockNumber: '0x10b7a6d',
    ...
    },
    {
        ...
        params: [sdk_core_1.HexInt.of(0).toString(), '0x0'],
        expected: null
    }
];
exports.ethGetTransactionByBlockNumberAndIndexTestCases = ethGetTransactionByBlockNumberAndIndexTestCases;
...
exports.invalidEthGetTransactionByBlockNumberAndIndexTestCases = invalidEthGetTransactionByBlockNumberAndIndexTestCases;
