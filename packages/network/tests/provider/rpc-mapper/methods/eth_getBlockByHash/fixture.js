...
exports.invalidEthGetBlockByHashTestCases = exports.ethGetBlockByHashTestCases = void 0;
const fixture_1 = require("../../../fixture");
const fixture_2 = require("../eth_getBlockByNumber/fixture");
...
exports.ethGetBlockByHashTestCases = ethGetBlockByHashTestCases;
/**
...
const invalidEthGetBlockByHashTestCases = [
    ...
    {
        description: 'Should throw an error when we use getBlockByNumber parameters for block number',
        params: ['latest', false],
        expectedError: sdk_errors_1.JSONRPCInvalidParams
    }
];
exports.invalidEthGetBlockByHashTestCases = invalidEthGetBlockByHashTestCases;
