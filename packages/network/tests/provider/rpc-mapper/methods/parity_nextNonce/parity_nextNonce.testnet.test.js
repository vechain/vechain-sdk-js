 ...
 */
(0, globals_1.describe)('RPC Mapper - parity_nextNonce method tests', () => {
    /**
     ...
     */
    (0, globals_1.describe)('parity_nextNonce - Not Implemented', () => {
        /**
        ...
        (0, globals_1.test)('Should throw JSONRPCMethodNotImplemented error', async () => {
            await (0, globals_1.expect)(provider.request({
                method: src_1.RPC_METHODS.parity_nextNonce,
                params: []
