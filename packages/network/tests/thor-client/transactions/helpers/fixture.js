...
exports.delegationHandlerFixture = void 0;
/**
...
const delegationHandlerFixture = [
    ...
    {
        testName: 'Should be able to use DelegationHandler with not empty gasPayer - gasPayerServiceUrl',
        gasPayer: {
    ...
    {
        testName: 'Should be able to use DelegationHandler with not empty gasPayer - gasPayerPrivateKey',
        gasPayer: {
    ...
    {
        testName: 'Should be able to use DelegationHandler with empty gasPayer - undefined',
        expected: {
            isDelegated: false,
    ...
    // Empty gasPayer - null
    {
        testName: 'Should be able to use DelegationHandler with empty gasPayer - null',
        gasPayer: null,
        expected: {
            isDelegated: false,
            gasPayerOrUndefined: undefined,
...
exports.delegationHandlerFixture = delegationHandlerFixture;
