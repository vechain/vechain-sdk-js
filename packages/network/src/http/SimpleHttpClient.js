...
exports.SimpleHttpClient = void 0;
...
class SimpleHttpClient {
     ...
     */
    constructor(baseURL, headers = new Headers(), timeout = SimpleHttpClient.DEFAULT_TIMEOUT) {
    ...
    async get(path, params) {
        return await this.http(HttpMethod_1.HttpMethod.GET, path, params);
    }
    /**
    ...
    async http(method, path, params) {
        ...
        try {
            ...
            // Log the request
            requestStartTime = (0, trace_logger_1.logRequest)(method, url.toString(), headerObj, method !== HttpMethod_1.HttpMethod.GET ? params?.body : undefined);
            // Send request
            const response = await fetch(url.toString(), {
                method,
                headers,
                body: method !== HttpMethod_1.HttpMethod.GET
            ...
            if (response.ok) {
                ...
                (0, trace_logger_1.logResponse)(requestStartTime, url.toString(), responseHeaders, responseBody);
            ...
            if (url) {
                ...
                (0, trace_logger_1.logError)(requestStartTime, urlString, method, error);
                ...
                if (error instanceof TypeError) {
                    throw new sdk_errors_1.HttpNetworkError('HttpClient.http()', error.message, {
                        method,
                        url: urlString,
                ...
                throw new sdk_errors_1.InvalidHTTPRequest('HttpClient.http()', error.message, {
                    method,
                    url: urlString
                }, error);
            }
                ...
                throw new sdk_errors_1.InvalidHTTPParams('HttpClient.http()', error.message, {
                    method,
                    url: fallbackUrl
                }, error);
            }
    ...
    async post(path, params) {
        return await this.http(HttpMethod_1.HttpMethod.POST, path, params);
    }
}
