...
exports.ethGetUncleByBlockNumberAndIndex = void 0;
 ...
 */
const ethGetUncleByBlockNumberAndIndex = async (params) => {
    // Input validation
    if (params.length !== 2 ||
        typeof params[0] !== 'string' ||
        typeof params[1] !== 'string')
        throw new sdk_errors_1.JSONRPCInvalidParams('eth_getUncleByBlockNumberAndIndex', 'Invalid input params for "eth_getUncleByBlockNumberAndIndex" method. See https://docs.infura.io/api/networks/ethereum/json-rpc-methods/eth_getunclebyblocknumberandindex for details.', { params });
    return await Promise.resolve(null);
};
exports.ethGetUncleByBlockNumberAndIndex = ethGetUncleByBlockNumberAndIndex;
