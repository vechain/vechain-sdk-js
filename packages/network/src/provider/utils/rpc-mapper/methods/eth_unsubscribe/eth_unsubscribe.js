 ...
 */
const ethUnsubscribe = async (params, provider) => {
    let result = false;
    if (provider === undefined) {
        throw new sdk_errors_1.JSONRPCInternalError('eth_unsubscribe()', 'Method "eth_unsubscribe" failed. Provider is not defined.', {
...
exports.ethUnsubscribe = ethUnsubscribe;
