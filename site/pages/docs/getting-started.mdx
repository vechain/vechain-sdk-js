...
Vechain SDK is a TypeScript interface for Vechain that provides low-level stateless primitives for interacting with Vechain. Vechain SDK is focused on developer experience, stability, bundle size, and performance:

- **Developer experience** Automatic [type safety and inference](/docs/typescript), comprehensive documentation, composable APIs.
- **Stability** Test suite runs against forked Vechain networks, complete [test coverage](https://app.codecov.io/gh/wevm/viem).
