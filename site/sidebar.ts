    ...
    '/docs/': [
        {
            text: 'Introduction',
            items: [
                { text: 'Why VechainSDK', link: '/docs/introduction' },
        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    link: '/docs/guides/blob-transactions'
                }
            ]
        },
        {
        ...
        },
        {
            ...
            items: [
                {
                    text: 'Introduction',
                    link: '/docs/actions/public/introduction'
                },
                {
                    text: 'Access List',
                    items: [
                ...
                },
                {
                    ...
                    items: [
                        {
                            text: 'getBlock',
                            link: '/docs/actions/public/getBlock'
                        },
                        {
                            text: 'getBlockNumber',
                ...
                },
                {
                    ...
                    items: [
                        {
                            text: 'getChainId',
                            link: '/docs/actions/public/getChainId'
                        }
                    ]
                },
                {
        ...
        },
        {
            ...
            items: [
                {
                    text: 'Introduction',
                    link: '/docs/actions/wallet/introduction'
                },
                {
                    text: 'Account',
                    items: [
        ...
        },
        {
            ...
            items: [
                {
                    text: 'Introduction',
                    link: '/docs/actions/test/introduction'
                },
                {
                    text: 'Account',
                    items: [
                        ...
                        {
                            text: 'setBalance',
                            link: '/docs/actions/test/setBalance'
                        },
                        { text: 'setCode', link: '/docs/actions/test/setCode' },
                        {
                            text: 'setNonce',
                            link: '/docs/actions/test/setNonce'
                        },
                        {
                            text: 'setStorageAt',
                ...
                },
                {
                    ...
                    items: [
                        {
                            text: 'getAutomine',
                            link: '/docs/actions/test/getAutomine'
                        },
                        {
                            text: 'increaseTime',
                        ...
                        {
                            text: 'setAutomine',
                            link: '/docs/actions/test/setAutomine'
                        },
                        {
                ...
                },
                {
                    ...
                    items: [
                        {
                            text: 'setCoinbase',
                            link: '/docs/actions/test/setCoinbase'
                        },
                        {
                            text: 'setMinGasPrice',
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            text: 'setRpcUrl',
                            link: '/docs/actions/test/setRpcUrl'
                        }
                    ]
                },
                {
                    ...
                    items: [
                        {
                            text: 'dumpState',
                            link: '/docs/actions/test/dumpState'
                        },
                        {
                            text: 'loadState',
                            link: '/docs/actions/test/loadState'
                        },
                        { text: 'revert', link: '/docs/actions/test/revert' },
                        {
                            text: 'snapshot',
                            link: '/docs/actions/test/snapshot'
                        }
                    ]
                },
                {
            ...
            items: [
                { text: 'JSON-RPC Account', link: '/docs/accounts/jsonRpc' },
                {
                    ...
                    items: [
                        ...
                        {
                            text: 'Custom',
                            link: '/docs/accounts/local/toAccount'
                        },
                        {
                            text: 'Utilities',
                            items: [
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        {
                            text: 'getEnsName',
                            link: '/docs/ens/actions/getEnsName'
                        },
                        {
                            text: 'getEnsResolver',
                ...
                },
                {
                    ...
                    items: [
                        {
                            text: 'labelhash',
                            link: '/docs/ens/utilities/labelhash'
                        },
                        {
                            text: 'namehash',
                            link: '/docs/ens/utilities/namehash'
                        },

                        {
                            text: 'normalize',
                            link: '/docs/ens/utilities/normalize'
                        }
                    ]
                }
            ]
