...
const TEST_PRIVATE_KEY =
    '0x7582be8411840400ee9e6cae447c82bb572304575650a5a5e975a2f5bd5bb337';
...
async function testThorClientApproach() {
    ...
    try {
        ...
        console.log(
            `✅ VET contract loaded at ${vetContractAddress.toString()}`
        );
        ...
        try {
            ...
            console.log(`❌ Error reading VET balance`);
        }
        ...
        try {
            ...
            console.log(`❌ Error reading VET total supply`);
        }
        ...
        console.error('❌ ThorClient test failed');
        return false;
    }
}
...
async function testViemCompatibleApproach() {
    ...
    try {
        ...
        console.error('❌ Viem-compatible test failed');
        return false;
    }
}
...
async function main() {
    ...
    console.log(
        `🔧 ThorClient Approach: ${results.thorClient ? '✅ PASS' : '❌ FAIL'}`
    );
    console.log(
        `🔧 Viem-Compatible Approach: ${results.viemCompatible ? '✅ PASS' : '❌ FAIL'}`
    );
