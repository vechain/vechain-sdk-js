...
const expected2 = [
    {
         ...
         */
        data: '0x00000000000000000000000000000000000000000000000000038d7ea4c68000', //equivalent to 1000000000000000 wei (0,001 VTHO)
        events: [],
        transfers: [],
        gasUsed: 591,
        reverted: false,
...
// 3 - Check the result (i.e. the return values are accurate)
expect(JSON.stringify(simulatedTx2)).toStrictEqual(
...
const expected3 = [
    {
        ...
        events: [
            {
                address:
                    '0841a6556c524d47030762eb14dc4af897e605d9b', //address of the smart contract
                topics: [
...
// 3 - Check the result
expect(JSON.stringify(simulatedTx3)).toStrictEqual(
