...
function getSnippetFilePath(tag: string, tagLine: string): string {
...
function getSnippetName(tag: string, tagLine: string): string {
...
function getTag(tagline: string): string {
...
function getSnippetContent(tag: string, tagLine: string): string {
