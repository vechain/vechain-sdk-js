...
import { Transaction, Address, HDKey, Units } from '@vechain/sdk-core';
...
const clause = [
    {
        ...
        value: `0x0`,
        data: `0xa9059cbb000000000000000000000000${Address.of('0x051815fdc271780de69dd8959329b27d6604469e')
            .toString()
            .toLowerCase()
