...
const txBody1 = await thorClient.transactions.buildTransactionBody(clauses, gasResult.totalGas, priorityOnlyOptions);
...
const txBody2 = await thorClient.transactions.buildTransactionBody(clauses, gasResult.totalGas, maxOnlyOptions);
...
const txBody3 = await thorClient.transactions.buildTransactionBody(clauses, gasResult.totalGas, bothOptions);
