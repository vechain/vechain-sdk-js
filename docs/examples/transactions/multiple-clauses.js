import { Address, Clause, networkInfo, Secp256k1, Transaction, VET, VTHO } from '@vechain/sdk-core';
...
const clauses = [
    ...
    Clause.transferVTHOToken(Address.of('0x7567d83b7b8d80addcb281a71d54fc7b3364ffed'), VTHO.of(10000)).clause
];
