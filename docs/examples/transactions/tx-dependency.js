import { Address, Clause, HexUInt, Secp256k1, VET, Transaction, networkInfo } from '@vechain/sdk-core';
import { expect } from 'expect';
// START_SNIPPET: TxDependencySnippet
// 1 - Define transaction clauses
const txAClauses = [
    Clause.transferVET(Address.of('0x7567d83b7b8d80addcb281a71d54fc7b3364ffed'), VET.of(1000))
];
const txBClauses = [
    Clause.transferVET(Address.of('0x7ccadeea14dd6727845b58f8aa7aad0f41a002a2'), VET.of(1))
];
